...
const Footer = () => {
  const quickLinks = [
    ...
    { label: "Latest School News", href: "#news" },
    { label: "Application Forms", href: "#application" },
    { label: "Find Our Campus", href: "#location" },
  ];
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex flex-col">
                  <span>063 881 9869</span>
                  <span>071 345 8605</span>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2.5">
                ...
                <span>3432 Bophuthatswana St, Boitekong, Rustenburg, 0300</span>
              </div>
